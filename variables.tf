...
## Variable de la URL base del bucket público de imágenes de productos, usada para completar el campo images de cada producto
variable "images_base_url" {
  description = "URL base HTTPS del bucket público de imágenes de productos (sin slash final)"
  type        = string
}
